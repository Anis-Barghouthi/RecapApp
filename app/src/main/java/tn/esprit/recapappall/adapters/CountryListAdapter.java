...
public class CountryListAdapter extends RecyclerView.Adapter<CountryListAdapter.WordViewHolder> {
    ...
    @NonNull
    @Override
    public CountryListAdapter.WordViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CountryListAdapter.WordViewHolder holder, int position) {
