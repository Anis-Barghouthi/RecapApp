...
public class NewAdapter extends RecyclerView.Adapter<NewAdapter.NewClass> {
    ...
    @NonNull
    @Override
    public NewAdapter.NewClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NewAdapter.NewClass holder, int position) {
